...
const STEPS = [
  ...
  },
  {
    ...
    body: "In Place, drag the object. Pick a shape and one of the hundred and eight colourways from the Element row while you are there — what it is and where it goes are the same decision, so they sit in the same bar.",
  },
  {
